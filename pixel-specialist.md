---
description: Ativa o agente Pixel-specialist
---

# Ativação do Agente Pixel-specialist

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `squads/media-buyer-squad/agents/pixel-specialist.md`
