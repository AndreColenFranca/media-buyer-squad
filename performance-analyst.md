---
description: Ativa o agente Performance-analyst
---

# Ativação do Agente Performance-analyst

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `squads/media-buyer-squad/agents/performance-analyst.md`
